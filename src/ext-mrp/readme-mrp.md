...
* **поставщики**: сведения о поставщиках ресурсов и основные условиях их поставки 
...
* `date`(datetime): Дата. Дата фиксации данных остатков, для остатков в незавернешшном производстве - дата завершения производства и передачи готовой продукции на склад
...
Свойства:
* `id`(id): Id. Идентификатор
* `stage`(-> MrpStage): Этап. Ссылка на этап производства, для которого уазана норма расхода
...
* `invoicePrice`(decimal): Цена. Прайсовая цена поставляемого ресурса
...
Результатом работы алгоритма планирования является появление сведений о заказе ресурсов в таблице MrpResourceStock "Остатки ресурсов", а также сведений о произведеннх партиях продукции в таблице MrpProductStock "Остатки продукции".
...
Для планирования производства партии: Берем все этапы производства этой продукции. Сортируем в порядке следования прозводственных 
этапов, от самых первых этапов к последующим. Обрабатываем все этапы. 
...
(!) Подумать над планированием изменения стоимости ресурсов - сделать возможность указания разных цен на ресурсы во 
времени. Отдельная система планирования курсов валют.
