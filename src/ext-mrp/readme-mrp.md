...
(!) переделать справочник контрагентов - сделать отдельный справочник для контагента, в нём указать ссылку на группу 
...
годности планируется использовать на каком этапе

(!) изменение рецептуры продукта с определенной даты; например, меняется сырье; 
...
(!) валюта покупки с указанием планового прогнозного курса валюты с определенного периода в будущем;

(!) различные сценарии планирования; возможность указания различных параметров при планировании;
