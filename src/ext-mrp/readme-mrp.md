...
![readme-mrg-img1.svg](readme-mrg-img1.svg)
...
Модель обеспечивает описание процесса
...
* `vendor`(-> MrpTerm): Поставщик. Ссылка на поставщика
...
* `price`(decimal): Цена. Цена поставляемого ресурса по прайсу
